# this is just a test script to look at the influence of t_melt=-1°C vs t_melt=0°C
# The outcome is not used for the manuscript!

path_calib_data = '/home/users/lschuster/oggm_mb_sandbox_option_intercomparison/trials_or_old_notebooks'
